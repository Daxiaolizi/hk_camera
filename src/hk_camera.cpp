...
void HKCameraNodelet::onInit()
{
  ...
  nh_.param("image_width", image_width_, 3072);
  nh_.param("image_height", image_height_, 2048);
  ...
  nh_.param("frame_rate", frame_rate_, 60.0);
  ...
  nh_.param("gain_value", gain_value_, 23.9);
  nh_.param("gain_auto", gain_auto_, false);
  nh_.param("gamma_selector", gamma_selector_, 2);
  nh_.param("gamma_value", gamma_value_, 0.5);
  nh_.param("exposure_auto", exposure_auto_, false);
  nh_.param("exposure_value", exposure_value_, 10000.0);
  ...
  nh_.param("resolution_ratio_width", resolution_ratio_width_, 3072);
  ...
  int nRet = MV_CC_GetStringValue(dev_handle_, "DeviceSerialNumber", &stStrValue);
  if (MV_OK != nRet)
...
int HKCameraNodelet::resolution_ratio_width_ = 3072;
int HKCameraNodelet::resolution_ratio_height_ = 2048;
}  // namespace hk_camera
